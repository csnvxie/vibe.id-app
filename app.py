...
if menu == "Pembeli":
    ...
    with col_left:
        # KOTAK STEP 1 (Custom HTML Card: Agak berwarna tapi nyaru #131B2E)
        st.markdown("""
        <div style="background-color: #131B2E; border: 1px solid #263353; border-radius: 16px; padding: 22px; margin-bottom: 20px;">
        """, unsafe_allow_html=True)
        ...
        # KOTAK STEP 2 (Custom HTML Card: Agak berwarna tapi nyaru #131B2E)
        st.markdown("""
        <div style="background-color: #131B2E; border: 1px solid #263353; border-radius: 16px; padding: 22px; margin-bottom: 20px;">
        """, unsafe_allow_html=True)
    ...
    with col_right:
        # KOTAK STEP 3 (Custom HTML Card: Agak berwarna tapi nyaru #131B2E)
        st.markdown("""
        <div style="background-color: #131B2E; border: 1px solid #263353; border-radius: 16px; padding: 22px; margin-bottom: 20px;">
        """, unsafe_allow_html=True)
